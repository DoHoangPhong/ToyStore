      ...
      <div class="container-fluid">
        ...
        <div class="navigation__column center">
          <ul class="main-menu menu">
            ...
            <li class="menu-item menu-item-has-children dropdown"><a href="contact-us.php">New</a>
            </li>
          </ul>
        </div>
          ...
          <div class="col-lg-10 col-md-12 col-lg-offset-1">
            <div class="ps-product__thumbnail">
              ...
              <div class="ps-product__image">
                <?php
                      foreach($arrLinkImage as $linkImage){
                    ?>
                <div class="item"><img id="shoeImageZoom" class="zoom" src="<?php echo $linkImage['link_image'] ?>"
                    alt="" data-zoom-image="<?php echo $linkImage['link_image'] ?>"></div>
                <?php
                      }
                    ?>
              </div>
            ...
            <div class="ps-product__thumbnail--mobile">
              ...
              <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true"
                ...
                data-owl-duration="1000" data-owl-mousedrag="on"><img src="images/shoe-detail/1.jpg" alt=""><img
                  src="images/shoe-detail/2.jpg" alt=""><img src="images/shoe-detail/3.jpg" alt=""></div>
            </div>
            ...
            <div class="ps-product__shopping">
              ...
              <div class="ps-product__actions"><a class="mr-10" href="whishlist.php"><i class="ps-icon-heart"></i></a><a
                  href="compare.php"><i class="ps-icon-share"></i></a></div>
            </div>
            </form>
              ...
              <div class="ps-review">
                ...
                <div class="ps-review__content">
                  ...
                  <p>Soufflé danish gummi bears tart. Pie wafer icing. Gummies jelly beans powder. Chocolate bar pudding
                    macaroon candy canes chocolate apple pie chocolate cake. Sweet caramels sesame snaps halvah bear
                    claw wafer. Sweet roll soufflé muffin topping muffin brownie. Tart bear claw cake tiramisu chocolate
                    bar gummies dragée lemon drops brownie.</p>
                </div>
              </div>
